        ...
        <div className="absolute right-0 flex items-center space-x-4">
          {user ? (
              ...
              {isDropdownOpen && (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center w-full text-left px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors duration-200 group cursor-pointer"
                  >
            ...
            <>
              <Link
                href="/login"
                className={`group px-6 py-3 bg-gradient-to-r from-gray-800 to-black text-white rounded-xl hover:from-gray-900 hover:to-gray-800 transition-all duration-300 font-medium text-lg shadow-lg hover:shadow-xl hover:scale-105`}
              >
                Sign In
              </Link>
              <Link
                href="/register"
                className={`group px-6 py-3 bg-white text-black rounded-xl hover:bg-gray-100 hover:border-gray-300 border border-gray-200 transition-all duration-300 font-medium text-lg shadow-lg hover:shadow-xl hover:scale-105`}
              >
                Register
              </Link>
            </>
