        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg h-fit">
            ...
            <form onSubmit={handleFilterSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="group w-full bg-gradient-to-r from-gray-800 to-black text-white py-3.5 rounded-xl hover:from-gray-900 hover:to-gray-800 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl font-medium flex items-center justify-center space-x-2 cursor-pointer"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {totalPages > 1 && (
                  <div className="mt-12 flex justify-center space-x-2">
                    <button
                      ...
                      className="group px-6 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 transform hover:scale-105 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                      Previous
                    </button>
